...
class Login:public Bank{
	...
	cout<<"\t\t\t\t\t"<<load<<"      ~~~~~~~~~~~~~~~~~~~     "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"                              "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"           Kartikeya          "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"            Anushka           "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"             Yasir            "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"                              "<<load<<endl;
	cout<<"\t\t\t\t\t"<<load<<"                              "<<load<<endl;
	cout<<"\t\t\t\t\t";
	for(int i=0;i<=31;i++)
	...
	//cin >> pin;
	    ...
	    while(password!=13) //ascii code of enter. this will terminate on enter
	    {
...
class Customer: public Bank{
	...
	cout<<"\t\t\t\t\t  PIN       : ";
	 while( length!=4) //ascii code of enter. this will terminate on enter
	    {
		   if (password>=48 && password<=57)//take value only in numeric form
		{
			pin.push_back(password);
	...
	password=0;
	cout<<"\n\t\t\t\t\t  Mobile    : ";
	 while( length!=11) //ascii code of enter. this will terminate on enter
	    {
		   if(password>=48 && password<=57) //take value only in numeric form
		{
	...
	password=0;
	cout<<"\n\t\t\t\t\t  CNIC      : ";
	while(length!=13) //ascii code of enter. this will terminate on enter
	    {
		   if(password>=48 && password<=57) //take value only in numeric form
		{
...
class User_Account:public Bank{
	...
	cin>>id;
	cout<<"\t\t\t\t\t         PIN : ";
	while(password!=13 && length!=4) //ascii code of enter. this will t3rminate on enter
	    {
		   if (password>=48 && password<=57)//take value only in numeric form
		{
			pin.push_back(password);
	...
	cout<<"\t\t\t\t\t      CNIC : ";
	char p=0;
	while(p!=13 && length!=13) //ascii code of enter. this will terminate on enter
	    {
...
int main(){
	...
	{
		int Select;
		wlm="     THANK YOU, YOU'VE SUCCESSFULY ENTERED ";
		a[0]->starting_line(wlm);
		do{
			system("cls");
